...
export const ptBR: Translations = {
  ...
  // Auth — login
  'auth.login.title': 'Seu inglês começa aqui.',
  'auth.login.subtitle': 'Fale inglês com confiança no dia a dia.',
  ...
  'profile.deleteAccountTitle': 'Excluir sua conta?',
  'profile.deleteAccountBody': 'Isso apaga sua conta e todo o seu progresso, ofensivas e cartões salvos. Não é possível desfazer.',
  'profile.deleteAccountConfirm': 'Excluir para sempre',
  'profile.deleteAccountCancel': 'Manter minha conta',
  ...
  // Home (o dashboard da spec: onde estou, progresso, o que vem depois)
  'home.subtitle': 'Vamos continuar sua jornada?',
  'home.hello': 'Olá,',
  'home.todayPlan': 'Plano de hoje',
  'home.conversation': 'Conversação',
  'home.listening': 'Listening',
  'home.lessonsProgress': '{{done}} de {{total}} lições',
  'home.cardsProgress': '{{done}} de {{total}} cartões',
  'home.audioProgress': '{{done}} de {{total}} áudios',
  'home.live': 'AO VIVO',
  ...
  'home.profile': 'Perfil',
  'home.loading': 'Carregando sua jornada…',
  'home.noPlanets': 'Nenhum planeta ainda — comece pelo Planeta 1.',
  'home.continueLearning': 'Continuar aprendendo',
  'home.flashcards': 'Cartões',
  'home.progressSummary': 'Seu progresso',
  ...
  'flashcards.speak': 'Fale',
  'flashcards.hint': 'Dica',
  'flashcards.revealTranslation': 'Ver tradução',
  'flashcards.hideTranslation': 'Esconder tradução',
  'flashcards.hintTitle': 'Como a frase é construída',
  'flashcards.partSubject': 'Sujeito',
  'flashcards.partVerb': 'Verbo',
  'flashcards.partComplement': 'Complemento',
  'flashcards.hintEmpty': 'Não há análise disponível para este cartão.',
  'flashcards.hintWhy': 'Por que funciona',
  'flashcards.hintDone': 'Entendi',
  'flashcards.practiceTitle': 'Prática de fala',
  'flashcards.practiceSubtitle': 'Repita em voz alta com seu tutor',
  'flashcards.practicePrompt':
    'O aluno está praticando a seguinte frase: “{{sentence}}”. Peça para repeti-la em voz alta, corrija a pronúncia com delicadeza quando necessário e mantenha a sessão curta e encorajadora. Foque apenas nesta frase e em variações próximas.',
  'flashcards.practiceListening': 'Ouvindo — repita a frase',
  'flashcards.practiceEmpty': 'Toque no botão de parar quando terminar de praticar.',
  'flashcards.practiceStop': 'Parar prática',
  'flashcards.practiceDone': 'Concluir',
  ...
  'planets.journeyTitle': 'Sua jornada',
  'planets.journeyCounter': '{{completed}} de {{total}} planetas',
  'planets.blockTag': 'Bloco {{number}}',
  'planets.ofBlocksDone': 'de {{total}} blocos concluídos',
  'planets.ofProgress': 'de progresso',
  'planets.footerCount': '{{total}} planetas',
  'planets.footerHint': 'cada planeta, novos blocos',
  'planets.journeySubtitle': '{{completed}} de {{total}} planetas conquistados',
  'planets.showFullMap': 'Mapa completo',
  'planets.showFocused': 'Visão focada',
  'planets.blocksOf': '{{completed}} de {{total}} blocos',
  'planets.reviewPending': 'Revisão pendente',
  'planets.reviewSkills': 'Revisar: {{skills}}',
  'planets.goalLabel': 'Objetivo de comunicação',
  'planets.skillsLabel': 'Competências desenvolvidas',
  ...
  'phase.basic': 'Comunicação básica',
  'phase.independence': 'Independência',
  'phase.fluency': 'Fluência funcional',
  'phase.advanced': 'Comunicação avançada',
  'phase.mastery': 'Domínio e naturalidade',
  'phase.range': 'Planetas {{first}}–{{last}} · {{level}}',

  // Estados do planeta e do bloco
