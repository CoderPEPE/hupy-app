...
('verified_1',     'Proven Once',    'Have a card you rated easy confirmed live by hupy', 'shield', 'cards_verified', 1,   NULL, 'cards', 'bronze',   10, 6510),
...
-- ----------------------------------------------------------- conversation --
('talks_3',    'Three Sessions',  'Hold 3 conversations with hupy',                 'mic',        'conversations', 3,   NULL, 'conversation', 'bronze',   10, 7030),
('talks_5',    'Five Sessions',   'Hold 5 conversations with hupy',                 'mic',        'conversations', 5,   NULL, 'conversation', 'bronze',   10, 7050),
('talks_10',   'Regular Speaker', 'Hold 10 conversations with hupy',                'mic',        'conversations', 10,  NULL, 'conversation', 'silver',   25, 7100),
('talks_25',   'Confident Voice', 'Hold 25 conversations with hupy',                'mic',        'conversations', 25,  NULL, 'conversation', 'gold',     50, 7250),
('talks_50',   'Natural Talker',  'Hold 50 conversations with hupy',                'mic',        'conversations', 50,  NULL, 'conversation', 'gold',     50, 7500),
('talks_100',  'Never Silent',    'Hold 100 conversations with hupy',               'crown',      'conversations', 100, NULL, 'conversation', 'platinum', 100, 7900),
